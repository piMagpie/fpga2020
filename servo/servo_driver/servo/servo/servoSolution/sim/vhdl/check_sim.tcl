...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.servo.autotvin_up.dat"
         "c.servo.autotvin_down.dat"
         "c.servo.autotvout_dutyCycle.dat"
         "c.servo.autotvout_speed.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.servo.autotvout_dutyCycle.dat"
         "rtl.servo.autotvout_speed.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
