...
HD_PWD='C:/fpga/matrixMultiplication/matrixMultiplication.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_multiplayer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_multiplayer.tcl
