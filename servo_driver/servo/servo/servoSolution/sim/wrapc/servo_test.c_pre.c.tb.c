...
// ==============================================================
# 1 "C:/fpga/servo_driver/servo/servo/servo_test.c"
# 1 "C:/fpga/servo_driver/servo/servo/servo_test.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/fpga/servo_driver/servo/servo/servo_test.c" 2
...
# 2 "C:/fpga/servo_driver/servo/servo/servo_test.c" 2
...
# 3 "C:/fpga/servo_driver/servo/servo/servo_test.c" 2

#ifndef HLS_FASTSIM
#ifndef HLS_FASTSIM
#include "apatb_servo.h"
#endif
# 4 "C:/fpga/servo_driver/servo/servo/servo_test.c"
int main() {

 char speed = 0;
 char duty_cycle = 0;
 char up = 1,down = 0,left = 0,right = 0;
 
#ifndef HLS_FASTSIM
#define servo AESL_WRAP_servo
#endif
# 9 "C:/fpga/servo_driver/servo/servo/servo_test.c"
servo(&up, &down, &left, &right, &duty_cycle, &speed);
#undef servo
# 9 "C:/fpga/servo_driver/servo/servo/servo_test.c"


 if (duty_cycle != (char) 150) {
...
#endif
# 19 "C:/fpga/servo_driver/servo/servo/servo_test.c"
