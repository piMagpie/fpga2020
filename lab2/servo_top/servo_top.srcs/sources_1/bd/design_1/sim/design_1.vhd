...
entity design_1 is
  ...
  attribute CORE_GENERATION_INFO of design_1 : entity is "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of design_1 is
  ...
  component design_1_pwm8_0_0 is
  port (
    pwm : in STD_LOGIC_VECTOR ( 7 downto 0 );
    clock : in STD_LOGIC;
    pwmout : out STD_LOGIC
  );
  end component design_1_pwm8_0_0;
  ...
  signal DeBounce_0_pulse_out : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal DeBounce_1_pulse_out : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal DeBounce_2_pulse_out : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal DeBounce_3_pulse_out : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal ap_clk_0_1 : STD_LOGIC;
  signal clk_div_0_clkout : STD_LOGIC;
  ...
  signal pwm8_0_pwmout : STD_LOGIC;
...
DeBounce_0: component design_1_DeBounce_0_0
     port map (
      Clock => ap_clk_0_1,
      button_in(7 downto 0) => p_up_0_1(7 downto 0),
      pulse_out(7 downto 0) => DeBounce_0_pulse_out(7 downto 0)
    );
DeBounce_1: component design_1_DeBounce_0_1
     port map (
      Clock => ap_clk_0_1,
      button_in(7 downto 0) => p_down_0_1(7 downto 0),
      pulse_out(7 downto 0) => DeBounce_1_pulse_out(7 downto 0)
    );
DeBounce_2: component design_1_DeBounce_0_2
     port map (
      Clock => ap_clk_0_1,
      button_in(7 downto 0) => p_right_0_1(7 downto 0),
      pulse_out(7 downto 0) => DeBounce_2_pulse_out(7 downto 0)
    );
DeBounce_3: component design_1_DeBounce_0_3
     port map (
      Clock => ap_clk_0_1,
      button_in(7 downto 0) => p_left_0_1(7 downto 0),
      pulse_out(7 downto 0) => DeBounce_3_pulse_out(7 downto 0)
    );
clk_div_0: component design_1_clk_div_0_0
     port map (
      clk => ap_clk_0_1,
      clkout => clk_div_0_clkout
    );
pwm8_0: component design_1_pwm8_0_0
     port map (
      clock => clk_div_0_clkout,
      pwm(7 downto 0) => servo_0_p_dutyCycle(7 downto 0),
      pwmout => pwm8_0_pwmout
    );
