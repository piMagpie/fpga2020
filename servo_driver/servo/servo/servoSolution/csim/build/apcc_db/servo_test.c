...
void servo( char ,  char ,  char ,  char ,  char *,  char *);
...
printf("\n = 0x%X\n", ((unsigned char )0));
if (AESL_DEBUG_TRACE)
printf("\n  call void @servo(i8 signext 1, i8 signext 0, i8 signext 0, i8 signext 0, i8* %%duty_cycle, i8* %%speed) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_17_count);
  servo(((unsigned char )1), ((unsigned char )0), ((unsigned char )0), ((unsigned char )0), ( char *)(&llvm_cbe_duty_cycle), ( char *)(&llvm_cbe_speed));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load i8* %%duty_cycle, align 1, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__1 = (unsigned char )*(&llvm_cbe_duty_cycle);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__1);
  if (((llvm_cbe_tmp__1&255U) == (((unsigned char )100)&255U))) {
...
llvm_cbe_tmp__8:
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = sext i8 %%1 to i32, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__2 = (unsigned int )((signed int )( char )llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([26 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%4, i32 %%4) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_30_count);
...
llvm_cbe_tmp__7:
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = load i8* %%speed, align 1, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_39_count);
  llvm_cbe_tmp__4 = (unsigned char )*(&llvm_cbe_speed);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = sext i8 %%7 to i32, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__5 = (unsigned int )((signed int )( char )llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([21 x i8]* @aesl_internal_.str1, i64 0, i64 0), i32 %%8, i32 %%8) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_42_count);
