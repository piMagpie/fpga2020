...
proc create_root_design { parentCell } {
  ...
  set down_0 [ create_bd_port -dir I -from 7 -to 0 -type data down_0 ]
  set dutyCycle_0 [ create_bd_port -dir O -from 7 -to 0 -type data dutyCycle_0 ]
  set left_r_0 [ create_bd_port -dir I -from 7 -to 0 -type data left_r_0 ]
  set right_r_0 [ create_bd_port -dir I -from 7 -to 0 -type data right_r_0 ]
