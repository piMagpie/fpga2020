...
HD_PWD='C:/fpga/lab2/servo_top/servo_top.runs/design_1_pwm8_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pwm8_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pwm8_0_0.tcl
