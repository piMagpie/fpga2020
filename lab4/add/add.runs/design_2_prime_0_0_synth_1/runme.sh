...
HD_PWD='C:/fpga/lab4/add/add.runs/design_2_prime_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_prime_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_prime_0_0.tcl
