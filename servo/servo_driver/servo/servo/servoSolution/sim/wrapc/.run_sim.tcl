...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "servo.autotvin.dat"
	set constFileTvOut       "servo.autotvout.dat"
	set constFileHdlTvIn     "servo.autohdltvin.dat"
	set constFileHdlTvOut    "servo.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
